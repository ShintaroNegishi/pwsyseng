...
#
# 今学期はこの WSCC 3 機 9 母線系統 1 つで押し通します。系統を覚え直さずに済むことを優先したためです。
...
# ## まとめ
#
# - 環境は `pwsyseng` 1 つ。`gridops`（前半）と `genstab`（後半）の両方が import できること
...
# - 末尾が `_mw` なら MW、そうでなければ p.u.。5 テーマは 1 つの問いの時間スケール違い
#
# ## 次回へ
#
